...
final class NetworkFlowGeneratorTest {
    ...
    void generatesDeterministicInstanceForSeed() {
        ...
        assertEquals(first.fixture().evidence().objectiveValue(), second.fixture().evidence().objectiveValue());
    ...
    void knownEvidenceMatchesCapacityFormula() {
        ...
        assertArrayEquals(
                ...
                instance.fixture().evidence().primal());
        assertEquals(relayFlow + directFlow, instance.fixture().evidence().objectiveValue().orElseThrow());
    }
    ...
    void generatedInstanceRejectsBlankMetadata() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new GeneratedLpInstance(
                " ",
