...
final class CscMatrixTest {
  ...
  void multipliesRectangularMatrix() {
    CscMatrix matrix =
        new CscMatrix(
            2, 3, new double[] {1.0d, 2.0d, 3.0d}, new int[] {0, 1, 0}, new int[] {0, 1, 2, 3});
  ...
  void rejectsBadPointers() {
    assertThrows(
        ...
        () -> new CscMatrix(1, 1, new double[] {1.0d}, new int[] {0}, new int[] {0, 2}));
    assertThrows(
        IllegalArgumentException.class,
        () -> new CscMatrix(1, 1, new double[0], new int[0], new int[] {1, 1}));
    assertThrows(
        IllegalArgumentException.class,
        () -> new CscMatrix(1, 1, new double[0], new int[0], new int[] {0, -1}));
  }
  ...
  void rejectsInvalidShapeAndIndexData() {
    assertThrows(
        IllegalArgumentException.class,
        () -> new CscMatrix(1, -1, new double[0], new int[0], new int[] {0}));
    assertThrows(
        IllegalArgumentException.class,
        () -> new CscMatrix(1, 1, new double[] {1.0d}, new int[0], new int[] {0, 1}));
    assertThrows(
        IllegalArgumentException.class,
        () -> new CscMatrix(1, 1, new double[] {1.0d}, new int[] {1}, new int[] {0, 1}));
  }
