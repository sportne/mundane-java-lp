...
final class SolverInputTest {
  ...
  void copiesExplicitNamesDefensively() {
    ...
    SolverInput input = new SolverInput(oneRowProblem(), oneEntryMatrix(), rows, columns, "OBJ");
  ...
  void rejectsShapeAndNameCount() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> new SolverInput(problem(), matrix(), List.of(), List.of("x", "x"), "OBJ"));
  }
  ...
  void rejectsNullInputs() {
    ...
    assertThrows(
        ...
        () -> new SolverInput(null, matrix(), List.of(), List.of("x"), "OBJ"));
    assertThrows(
        NullPointerException.class,
        () -> new SolverInput(problem(), null, List.of(), List.of("x"), "OBJ"));
    assertThrows(
        NullPointerException.class,
        () -> new SolverInput(problem(), matrix(), null, List.of("x"), "OBJ"));
    assertThrows(
        NullPointerException.class,
        () -> new SolverInput(problem(), matrix(), List.of(), null, "OBJ"));
    assertThrows(
        NullPointerException.class,
        () -> new SolverInput(problem(), matrix(), List.of(), List.of("x"), null));
  }
  ...
  void rejectsBlankAndDuplicateNames() {
    assertThrows(
        IllegalArgumentException.class,
        () ->
            new SolverInput(oneRowProblem(), oneEntryMatrix(), List.of(" "), List.of("x"), "OBJ"));
    assertThrows(
        IllegalArgumentException.class,
        () -> new SolverInput(problem(), matrix(), List.of(), List.of(" "), "OBJ"));
    assertThrows(
        IllegalArgumentException.class,
        () -> new SolverInput(problem(), matrix(), List.of(), List.of("x"), " "));
    assertThrows(
        IllegalArgumentException.class,
        () ->
            new SolverInput(
                twoRowProblem(), twoRowMatrix(), List.of("r", "r"), List.of("x"), "OBJ"));
  }
