...
--write <solution.sol>`. Output parsing is intentionally narrow: status and objective
evidence are read from GLPK text output, malformed numeric evidence is reported
as an adapter error, and unsupported MPS inputs are reported without starting
