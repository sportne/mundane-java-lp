...
final class OrToolsJavaAdapterTest {
    ...
    void normalizesResultStatuses() {
        ...
        assertEquals(SolverStatus.FEASIBLE, OrToolsJavaAdapter.normalize(MPSolver.ResultStatus.FEASIBLE));
        assertEquals(SolverStatus.INFEASIBLE, OrToolsJavaAdapter.normalize(MPSolver.ResultStatus.INFEASIBLE));
        assertEquals(SolverStatus.UNBOUNDED, OrToolsJavaAdapter.normalize(MPSolver.ResultStatus.UNBOUNDED));
        assertEquals(SolverStatus.NUMERICAL_FAILURE, OrToolsJavaAdapter.normalize(MPSolver.ResultStatus.ABNORMAL));
        assertEquals(SolverStatus.ERROR, OrToolsJavaAdapter.normalize(MPSolver.ResultStatus.MODEL_INVALID));
        assertEquals(SolverStatus.UNKNOWN, OrToolsJavaAdapter.normalize(MPSolver.ResultStatus.NOT_SOLVED));
    }
