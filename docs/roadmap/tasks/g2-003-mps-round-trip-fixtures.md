# G2-003 MPS round-trip fixtures
...
- REQ-V1-MPS-ROUND-TRIP

## References

- `docs/adr/ADR-0003-mps-as-initial-interchange-format.md`
- `docs/roadmap/tasks/g1-003-mps-format-design-completion.md`
...
- Implement MPS read/write round trips for the supported v1.0 subset.
