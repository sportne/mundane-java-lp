...
The current G10 performance evidence snapshot for this lane is recorded in
`docs/verification/performance-evidence-report.md`. It includes strict
comparison evidence with all required solvers available, but it remains
correctness-oriented evidence and does not make a solver-speed claim.
